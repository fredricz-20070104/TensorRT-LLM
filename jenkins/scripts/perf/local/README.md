...
python3 submit.py --test-list "perf/test_perf_sanity.py::test_e2e[aggr-deepseek_r1_fp4_v2_2_nodes_grace_blackwell-r1_fp4_v2_tep8_mtp3]" \
    ...
    --image "urm.nvidia.com#sw-tensorrt-docker/tensorrt-llm:pytorch-25.12-py3-aarch64-ubuntu24.04-trt10.14.1.48-skip-tritondevel-202602011118-10901" \
    --mounts "/home/scratch.svc_compute_arch:/home/scratch.svc_compute_arch,/home/scratch.trt_llm_data/llm-models:/home/scratch.trt_llm_data/llm-models,/home/scratch.trt_llm_data_ci/llm-models:/home/scratch.trt_llm_data_ci/llm-models" \
    --llm-models-root /home/scratch.trt_llm_data_ci/llm-models
```

Using `--config-file` and `--test-name`:

```bash
python3 submit.py --config-file /home/scratch.chenfeiz_gpu/repo/trtllm-1/tests/scripts/perf-sanity/deepseek_r1_fp4_v2_2_nodes_grace_blackwell.yaml \
    --test-name r1_fp4_v2_tep8_mtp3 \
    --partition gb200nvl72_preprod \
    --account coreai_comparch_trtllm \
    --job-name coreai_comparch_trtllm \
...
```bash
python3 submit.py --config-file /home/scratch.chenfeiz_gpu/repo/trtllm-1/tests/integration/defs/perf/disagg/test_configs/disagg/perf-sanity/gb200-deepseek-r1-fp4_1k1k_ctx1_dep4_gen1_dep4_eplb0_mtp1_ccb-UCX.yaml \
    --benchmark-mode gen_only \
    --partition gb200nvl72_preprod \
    --account coreai_comparch_trtllm \
    --job-name coreai_comparch_trtllm \
