...
def launchTestJobs(pipeline, testFilter)
{
    ...
    SBSASlurmTestConfigs = [
        ...
        "GB200-4_GPUs-PyTorch-PerfSanity-1": ["auto:gb200-x4", "l0_gb200_multi_gpus_perf_sanity", 1, 3, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-2": ["auto:gb200-x4", "l0_gb200_multi_gpus_perf_sanity", 2, 3, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-3": ["auto:gb200-x4", "l0_gb200_multi_gpus_perf_sanity", 3, 3, 4],
        // PerfSanity post-merge tests
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-1": ["auto:gb200-x4", "l0_gb200_multi_gpus_perf_sanity", 1, 2, 4],
        "GB200-4_GPUs-PyTorch-PerfSanity-Post-Merge-2": ["auto:gb200-x4", "l0_gb200_multi_gpus_perf_sanity", 2, 2, 4],
    ]
    ...
    // 1 Node
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB200-8_GPUs-1_Nodes-PyTorch-Disagg-PerfSanity-CTX1-NODE1-GPU1-Post-Merge",
        "auto:gb200-flex",
        "l0_gb200_multi_nodes_perf_sanity_ctx1_node1_gpu1",
        6,
        4,
        1
    )
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB200-8_GPUs-1_Nodes-PyTorch-Disagg-PerfSanity-CTX1-NODE1-GPU4-Post-Merge",
        "auto:gb200-flex",
    ...
    // 2 Nodes
    multiNodesSBSAConfigs += buildStageConfigs(
        "GB200-8_GPUs-2_Nodes-PyTorch-Disagg-PerfSanity-CTX1-NODE2-GPU8-Post-Merge",
        "auto:gb200-flex",
        "l0_gb200_multi_nodes_perf_sanity_ctx1_node2_gpu8",
        2,
        8,
        2
    )
